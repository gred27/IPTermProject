package com.github.groundred.iptermproject.ber;
...
*/
     ...
     * length specified.
     *
     * @param os     an {@code OutputStream} to which the header is encoded.
     * @param type   the type of the ASN.1 object. Must be &lt; 30, i.e. no extension octets.
     * @param length the length of the object. The maximum length is 0xFFFFFFFF;
     * @throws IOException if the output stream fails to store the encoded header.
     */
     ...
     * @param type           the type of the ASN.1 object. Must be &lt; 30, i.e. no extension octets.
     * @param length         the length of the object. The maximum length is 0xFFFFFFFF;
     * @param numBytesLength the number of bytes used to encode the length of the length.
     * @throws IOException if the output stream fails to store the encoded header.
     */
    public static void encodeHeader(OutputStream os, int type, int length,
                                    int numBytesLength)
     ...
     * @return the count of bytes needed to encode the value {@code length}
     */
     ...
     *
     * @param os     an {@code OutputStream} to which the length is encoded.
     * @param length the length of the object. The maximum length is 0xFFFFFFFF;
     * @throws IOException if the output stream fails to store the encoded length.
     */
     ...
     * @param os             an {@code OutputStream} to which the length is encoded.
     * @param length         the length of the object. The maximum length is 0xFFFFFFFF;
     * @param numLengthBytes the number of bytes to be used to encode the length using the long
     *                       form.
     * @throws IOException if the output stream fails to store the encoded length.
     */
    public static void encodeLength(OutputStream os, int length,
     ...
     * @throws IOException if the output stream fails to store the encoded integer.
     */
     ...
     *
     * @param value a BigInteger value with a length that is less 2^31.
     * @return the length of the BER encoding of the supplied BigInteger as INTEGER value.
     */
     ...
     * @param type  the tag type for the integer (typically 0x02)
     * @param value the integer value to encode.
     * @throws IOException if the output stream fails to store the encoded value.
     */
     ...
     * @param os     an {@code OutputStream} to which the length is encoded.
     * @param type   the tag type for the integer (typically 0x02)
     * @param string the {@code byte} array containing the octet string value.
     * @throws IOException if the output stream fails to store the encoded value.
     */
     ...
     *
     * @param value an array of unsigned integer values representing an object identifier.
     * @return the BER encoded length of the OID without header and length.
     */
     ...
     *
     * @param os   an {@code OutputStream} to which the length is encoded.
     * @param type the tag type for the integer (typically 0x06)
     * @param oid  the {@code int} array containing the OID value.
     * @throws IOException if the output stream fails to store the encoded value.
     */
     ...
     * @throws IOException if the input stream contains an invalid BER encoding or an IO
     ...
     *
     * @param is          an {@code InputStream}
     * @param checkLength if {@code false} length check is always suppressed.
     * @return the decoded length.
     * @throws IOException if the input stream contains an invalid BER encoding or an IO
     *                     exception occurred while reading from the stream.
     */
     ...
     * @param type        returns the type of the object at the current position in the input
     *                    stream.
     * @param checkLength if {@code false} length check is always suppressed.
     ...
     *
     * @return {@code true} if the length of a parsed SEQUENCE should be checked
     ...
     *
     * @param checkSequenceLen specifies whether he length of a parsed SEQUENCE should be checked
     *                         against the real length of the objects parsed.
     */
     ...
     * @param length int
     * @throws IOException if the bytes that are given in length cannot be read from the input
